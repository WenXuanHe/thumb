...
/******/ 	var hotCurrentHash = "bb88817d7cc202d9c864"; // eslint-disable-line no-unused-vars
...
var PraiseButton = function () {
	...
	_createClass(PraiseButton, [{
		key: "praiseAction",
		value: function praiseAction() {
			return ++this.praise;
		}
	}, {
		key: "getPraiseCount",
		value: function getPraiseCount() {
			return this.praise;
		}
	}]);
...
var _PraiseButton2 = __webpack_require__(1);
...
var Thumb = function (_PraiseButton) {
	...
	function Thumb() {
		var praise = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
	...
	_createClass(Thumb, [{
		...
		value: function events() {
			...
			$('#thumb').on('click', function () {
				$('#count').text(_this2.praiseAction());
			});
		}
	}]);
